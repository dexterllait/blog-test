        ...
        <Card className={classes.mb20}>
            <CardActionArea>
                <CardContent style={{backgroundColor: "white"}}>
                    ...
                    <Typography gutterBottom variant="h5" component="div" className={classes.colorBlack} title={'blog-title'}>
                        {props.blogData.title}
                    </Typography>
                    <Typography variant="body2" className={classes.colorGray}  title={'blog-body'}>
                        {props.blogData.body}
                    </Typography>
                </CardContent>
            </CardActionArea>
